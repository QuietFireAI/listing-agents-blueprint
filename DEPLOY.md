# DEPLOY - Listing Swarm (Real Estate) (v0.19, ratified 2026-07-18 - owner sign-off)
...
- MLS / syndication (OUT+IN)
- Lead sources / CRM (IN)
- E-signature platform (OUT+IN)
- Media vendors (photo/tour) (OUT+IN)
- Showing service (OUT+IN)
...
closed at load.
- `config/message_templates.json` - Approved outbound templates per audience/purpose
- `config/vendor_panel.json` - Approved media/staging/sign vendors with terms
- `config/milestone_map.json` - Listing lifecycle milestones and entry criteria
- `config/cadence_settings.json` - Chase/confirmation cadences and lead-times
- `config/authority_signers.json` - Humans authorized to sign authority intents
